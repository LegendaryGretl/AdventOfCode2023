...
came_from = {}
cost_so_far = {}
came_from[start.dict_key()] = None
cost_so_far[start.dict_key()] = 0
...
while not frontier.empty():
    ...
    for next in curr.neighbors():
        ...
        if next.dict_key() not in cost_so_far.keys() or new_cost < cost_so_far[next.dict_key()]:
            ...
            frontier.put((priority, dcpy(next)))
            came_from[next.dict_key()] = dcpy(curr)
...
# while curr != None and came_from[curr.dict_key()] != None:
#     c = curr.get_coord()
#     heat_map[c[0]][c[1]] = "+"
#     print(curr)
#     curr = came_from[curr.dict_key()]
